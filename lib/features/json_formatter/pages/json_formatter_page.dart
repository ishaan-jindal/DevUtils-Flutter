  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        ...
        body: BlocBuilder<JsonFormatterBloc, JsonFormatterState>(
              ...
              children: [
                ...
                JsonToolbar(
                  ...
                  onSample: () {
                    ...
                    // Update controller text after sample loads
                    Future.microtask(() {
                      final newState = context.read<JsonFormatterBloc>().state;
                      _inputController.text = newState.input;
                    });
                  },
                ),
